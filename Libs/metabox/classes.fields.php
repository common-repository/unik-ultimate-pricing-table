...
abstract class CMB_Field {
	...
	public function display() {
		...
		if ( $this->args['repeatable'] ) {
			...
			<button class="button repeat-field button button-primary"><?php esc_html_e( 'Add New', 'cmb' ); ?></button>
...
class CMB_Group_Field extends CMB_Field {
	...
	public function display() {
		...
		if ( $this->args['repeatable'] ) {
			...
			$this->value = ''; ?>
				...
				<button class="button repeat-field button button-primary"><?php esc_html_e( 'Add New Pricing Column', 'cmb' ); ?></button>
	...
	public function html() {
		...
		<?php if ( $this->args['repeatable'] ) : ?>
			<button class="cmb-delete-field button button-primary" title="Remove field"><span class="cmb-delete-field-icon">&times;</span> Remove Pricing Column</button>
		<?php endif; ?>
