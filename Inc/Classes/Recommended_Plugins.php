	...
	class Recommended_Plugins extends Recommended {
		...
		public function admin_menu() {
			...
			$this->sub_menu = add_submenu_page(
				'options-general.php',       // Ex. unik-ultimate-pricing-table-settings /  edit.php?post_type=page .
				__( 'Recommended', 'unik-ultimate-pricing-table' ),
				__( 'Recommended', 'unik-ultimate-pricing-table' ),
				'manage_options',
				'unik-ultimate-pricing-table-recommended-plugins',
